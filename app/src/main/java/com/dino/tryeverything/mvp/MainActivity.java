...
//        RecentlyFragment ganHuoFragment =
//                (RecentlyFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
//        if (ganHuoFragment == null) {
//            // Create the fragment
//            ganHuoFragment = RecentlyFragment.newInstance();
//            ActivityUtils.addFragmentToActivity(
//                    getSupportFragmentManager(), ganHuoFragment, R.id.contentFrame);
//        }
